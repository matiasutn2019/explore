...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(GET, "/movies/listado/**").hasAnyAuthority("ROLE_USER", "ROLE_ADMIN")
                .antMatchers(GET, "/movies").hasAnyAuthority("ROLE_USER", "ROLE_ADMIN")
                .antMatchers(POST, "/movies/crear/**").hasAnyAuthority("ROLE_ADMIN")
                .antMatchers(PUT, "/movies/editar/**").hasAnyAuthority("ROLE_ADMIN")
                .antMatchers(DELETE, "/movies/eliminar/**").hasAnyAuthority("ROLE_ADMIN")
                .and()
